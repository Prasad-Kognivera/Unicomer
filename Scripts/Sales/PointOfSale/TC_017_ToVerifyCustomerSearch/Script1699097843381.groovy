...
WebUI.setText(findTestObject('Object Repository/PointOfSale/Page_Cosacs/input_FirstName'), 'TestFirstName')

WebUI.click(findTestObject('Object Repository/PointOfSale/Page_Cosacs/button_Search'))

WebUI.verifyElementPresent(findTestObject('Object Repository/PointOfSale/Page_Cosacs/div_TestFirstName'), 0)

WebUI.verifyElementText(findTestObject('Object Repository/PointOfSale/Page_Cosacs/div_TestFirstName'), 'TestFirstName')
