...
errorMessage = WebUI.getText(findTestObject('Object Repository/searchOrder/Page_Search Order/p_Required fields are missing'))

if (errorMessage == 'Required field/s are missing') {
    println('Please update your search criteria with valid details..!!')
} else {
